  ...
  return (
    <>
      ...
      <form className="space-y-4" onSubmit={handleRegister}>
        ...
        <div className="pt-4">
          <button type="submit"
            className="w-full py-3 px-4 bg-primary hover:bg-primary/90 text-primary-foreground font-medium rounded-full shadow-sm transition-colors flex items-center justify-center">
            Create Account
